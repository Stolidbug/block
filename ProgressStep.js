...
.dark .dark\\:fill-white{--un-fill-opacity:1;fill:rgb(255 255 255 / var(--un-fill-opacity));}
  ...
  return r(n, y(C, {
    ...
    children: (e, _) => (() => {
      var s = D(), c = s.firstChild, d = c.firstChild, u = c.nextSibling, p = u.firstChild, $ = p.firstChild, b = $.nextSibling;
      b.nextSibling;
      var g = p.nextSibling;
      return r(c, (() => {
        var t = w(() => e.status === "valid");
        return () => t() && (() => {
          var o = E();
          return o._$owner = x(), o;
        })();
      })(), d), r(c, (() => {
        var t = w(() => e.status === "active" || e.status === "disabled");
        return () => t() && (() => {
          var o = F();
          return o._$owner = x(), o;
        })();
      })(), d), r(d, () => e.accessibleText), r(p, () => _() + 1, b), r(p, () => i.steps.length, null), r(u, y(T, {
        class: "step-title",
        get component() {
          return i.titleTag;
        },
      ...
      }), g), r(g, () => e.description), k((t) => {
        var o = e.status === "active", v = e.status === "valid", h = e.status === "disabled", f = !!(i.sm && e.status !== "active"), m = !!i.sm;
        return o !== t.e && s.classList.toggle("step-active", t.e = o), v !== t.t && s.classList.toggle("step-valid", t.t = v), h !== t.a && s.classList.toggle("step-disabled", t.a = h), f !== t.o && u.classList.toggle("sr-only", t.o = f), m !== t.i && g.classList.toggle("sr-only", t.i = m), t;
      }, {
        e: void 0,
        t: void 0,
        a: void 0,
  ...
  })), k(() => n.classList.toggle("step-group-sm", !!i.sm)), n;
})()]);
export {
  M as TAG
};
